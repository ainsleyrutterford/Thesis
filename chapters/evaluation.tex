...
\subsubsection{Varying Convolution Output Channels}
...
However, whilst experimenting with the number of output feature channel, it was found that lower numbers of feature channels produced better results. For example, dividing the original number of feature channels by 16 resulted in an accuracy of ...\% being achieved as opposed to the ...\% achieved with the factor of eight. This increase in performance may be due to the reduction in the number of trainable parameters acting as a regularization technique.
...
This architecture thus required a large amount of extra data to be labelled.

In hindsight, perhaps the labels sohuld be done one at a time constantly referencing the previous label in order to ensure that the labels are consistent throughout. However, labelling is already time consuming and this process would make it significantly longer.
...
Examples of high and low quality predictions produced by the final ablated two dimensional architecture are shown in Figures \ref{fig:finalresultsgood} and \ref{fig:finalresultsbad} respectively. The final cross-validated accuracy achieved was 77.8\%.

\begin{figure}[!p]
    \centering
    \includegraphics[width=0.93\textwidth]{images/final-results-good.png}
    \caption{Higher quality examples of the final predictions produced by the network.}
...
\begin{figure}[!p]
    \centering
    \includegraphics[width=0.93\textwidth]{images/final-results-good.png}
    \caption{Lower quality examples of the final predictions produced by the network.}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth, height=0.3\textwidth]{example-image-c}
