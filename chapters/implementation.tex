...
The possible transformations specified each have a random chance of being applied to each image. It was important to choose a range of possible transformations that would always produce a reasonable augmented image. The permitted augmentations were:

\begin{itemize}
    \item A random rotation within the range of $\pm 2$ degrees.
    \item A random shift in the $x$ axis within the range of $\pm 2\%$ of the image's width.
    \item A random shift in the $y$ axis within the range of $\pm 2\%$ of the image's height.
    \item A random shear 
    \item A random zoom 
    \item A random brightness shift
    \item A random horizontal flip
    \item A random vertical flip
\end{itemize}
