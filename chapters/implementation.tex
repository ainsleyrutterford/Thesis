...
\begin{figure}[!p]
    ...
    \caption{A diagram providing an overview of the components implemented throughout the project. The experimentation is discussed in Chapter \ref{chap:evaluation}.}
    \label{fig:overview}
\end{figure}
